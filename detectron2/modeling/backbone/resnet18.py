...
class ResNet(nn.Module):
    ...
    def output_shape(self):
         return {'res2': ShapeSpec(channels=64, height=None, width=None, stride=4),
         'res3': ShapeSpec(channels=128, height=None, width=None, stride=8),
         'res4': ShapeSpec(channels=256, height=None, width=None, stride=16),
         'res5': ShapeSpec(channels=512, height=None, width=None, stride=32)}
