...
class ROIPooler_level(nn.Module):
    """
    ...
    def forward(self, x: List[torch.Tensor], box_lists, box_level_logit):
        """
        Args:
        ...
        level_assignments= torch.argmax(cat(box_level_logit),1)    ##b3kd
